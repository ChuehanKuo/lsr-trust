    ...
    <footer className="bg-ink-900">
      <div className="max-w-5xl mx-auto px-5 sm:px-8 py-14">
        <div className="grid md:grid-cols-3 gap-10">
          <div>
            <h4 className="font-serif font-medium text-white text-sm mb-3">{REVIEW_META.shortTitle}</h4>
          ...
          <div>
            <h4 className="font-medium text-white/60 text-xs uppercase tracking-wide mb-3">Reporting Standards</h4>
            <ul className="space-y-2">
              {standards.map((s) => (
                <li key={s} className="flex items-center gap-2 text-xs text-white/35">
                  <div className="w-1 h-1 rounded-full bg-teal-500/40 shrink-0" />
                  {s}
                </li>
              ))}
            </ul>
          ...
          <div>
            <h4 className="font-medium text-white/60 text-xs uppercase tracking-wide mb-3">Contact</h4>
        ...
        <div className="mt-12 pt-6 border-t border-white/[0.06] flex flex-wrap items-center justify-between gap-3 text-[11px] text-white/15">
