  ...
  return (
    <footer className="border-t border-ink-200 bg-ink-50">
      <div className="max-w-[1100px] mx-auto px-6 py-14">
        <div className="grid md:grid-cols-3 gap-8 text-[13px] text-ink-500">
          <div>
            <p className="font-semibold text-ink-800 mb-2">{REVIEW_META.shortTitle}</p>
            <p className="leading-relaxed">Living Systematic Review — continuously updated evidence synthesis.</p>
          </div>
          <div>
            <p className="font-semibold text-ink-800 mb-2">Standards</p>
            <p className="leading-relaxed">PROSPERO / PRISMA-P / PRISMA-LSR / MMAT / GRADE</p>
          </div>
          <div>
            <p className="font-semibold text-ink-800 mb-2">Contact</p>
